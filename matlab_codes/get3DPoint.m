function point3d = get3Dpoint(j,frame,point,Transformations)
%camera parameters 
cx = 1242/2;
cy = 375/2;
fx = 718.0;
...
K = [fx 0 cx;0 fy cy;0 0 1];
    disp_image =  imread(strcat('/home/akhil/visual_odom/',seq,'/left_disparity/',int2str(j+floor(frame/2)),'.png'));
