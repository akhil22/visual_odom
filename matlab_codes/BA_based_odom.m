...
%     disp(tline);
        for l = 1:k-2
            ...
            for p=1:num_points
                ...
                points1=sscanf(g1{1}{2+8*id(1)},'%f');
                points2=sscanf(g2{1}{2+8*id(2)},'%f');
                if frame(1) == 0
                ...
                ba_input(1,point_index) = points1(2);
                ba_input(2,point_index) = points1(1);
                ...
                ba_input(1,point_index) = points2(2);
                ba_input(2,point_index) = points2(1);
                ba_input(3,point_index) = point3d(1);
                ba_input(4,point_index) = point3d(2);
                ba_input(5,point_index) = point3d(3);
                ba_input(6,point_index) = -0.1;
                ...
                matches(match_index,3) = frame(1)+1;
                matches(match_index,4) = frame(2)+1;
