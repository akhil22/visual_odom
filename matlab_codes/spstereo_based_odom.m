...
disp_image1 = imread(strcat('/home/akhil/visual_odom/',seq,'/left_disparity/',num2str(q+segment-1),'.png'));
disp_image2 = imread(strcat('/home/akhil/visual_odom/',seq,'/left_disparity/',num2str(q+segment),'.png'));
disp_image1 = disp_image1';
disp_image2 = disp_image2';
I1 = im2single(I1_l);
I2 = im2single(I2_l); 
...
pix_row = X1(2,t);
pix_col = X1(1,t);
dispar = double(disp_image1(round(pix_col),round(pix_row))./256.0);
x1(3,t) = fx*base_length./dispar;
x1(2,t) = (pix_row-cy)*x1(3,1)/fx;
x1(1,t) = (pix_col-cx)*x1(3,1)/fx;
pix_row = X2(2,t);
pix_col = X2(1,t);
dispar = double(disp_image2(round(pix_col),round(pix_row))./256.0);
