...
% seq no
seq = 'seq_0';
set_points = 'full_road';
perce = 10;
set_points = strcat(int2str(perce),'_per');
% set_points = 'far';
%read ground truth
...
% polygon cordinates of the image region we want to consider for
% correspondence matching perfect matches
% xi = [  485.7500
%   335.7500
%   704.7500
%   629.7500
...
%%polygon coordinates of far point correspondences 
% xi=1.0e+03 *[
%     0.0538
%     0.0583
%     1.1252
...
% % %%polygon coordinates of correspondences on the trees
%  xi=   1.0e+03 *[
%     0.8353
%     0.6522
%     0.6477
...
%      ];
% 
% %%polygon coordinates of the correspondences on the complete road
% xi= [364.2500
%     1.2500
%    35.7500
%   733.2500
...
% %%poygon coordinates fot the correspondences on the side part of the road
% xi=[ 323.7500
%     1.2500
%   280.2500
%   439.2500
...
%   253.2500
%     ];
% %%poygon coordinates for the correspondences on the ground
% xi= 1.0e+03 *[
%     0.6583
%     0.8022
%     1.2343
...
%     ];
% 
% %%poygon coordinates fot the correspondences on the ground and road
xi= 1.0e+03 *[
    0.3508
    0.6522
    0.7497
...
% feature_file = strcat('/home/akhil/Desktop/visual_odom/',seq,'/left_rijvi_match_features/',int2str(q-2+segment-1),'.txt')
...
point_file = strcat('/home/akhil/Desktop/visual_odom/visual_odom_plots/seq_0_results/ransac_check_results/rijvi_based_results/',set_points,'/',int2str(q-2+segment-1),'.txt')


% temp1 = (1:size(X1,1));
% temp2 = temp1(~in);
% num_pp = nnz(in==1);
% req_points = floor(num_pp*perce/100);
% 
% y = datasample(temp2,req_points,'Replace',false);
% 
% in(y) = 1;
% X1=X1(in);
% Y1=Y1(in);
...
%         if abs(temp_th1-temp_th2)<0.009
        if abs(theta(i) - theta(j)) < 0.05
            temp = temp+1;
        end
    end
    if temp > n_inliers
